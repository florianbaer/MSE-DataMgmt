...
//db.unicorns.updateOne({name: 'Aurora'}, {$pull: {loves: 'sugar'}})

db.unicorns.updateMany({gender: 'f', $or: [{loves:'carrot'}, {loves:'apple'}]}, {$push:{ loves: 'tomato'}})

db.unicorns.find({loves:'tomato'},{_id:0,dob:0,vampires:0,weight:0})
